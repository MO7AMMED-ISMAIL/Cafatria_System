...
<!--                        <span class="mr-2 d-none d-lg-inline text-gray-600 small">--><?php //=$currentAdmin['username']?><!--</span>-->
<!--                        <img class="rounded-circle" src="uploads/--><?php //=$currentAdmin['profile_picture']?><!--" width="20px" height="20px">-->
<!--                    </a>-->
