...
(3, 'mo7ismail88', 'fcisdodo900@gmail.com', '12345678', 'user.png', '2024-03-08 16:38:41');
...
INSERT INTO `orders` (`id`, `user_id`, `total_price`, `tax`, `total_price_after_tax`, `status`, `room`, `notes`, `order_date`) VALUES
(1, 1, 8, 0.1, 8.8, 'Done', 1, 'Special instructions for the order', '2024-03-08 11:33:07'),
(2, 2, 3.5, 0.1, 3.85, 'Processing', 1, NULL, '2024-03-08 11:33:07'),
(3, 2, 6.5, 0.1, 0.65, 'Processing', 2, 'fwrgvtebt3b', '2024-03-08 21:06:08');
...
(4, 3, 1, 2.5, 2, 5, '2024-03-08 21:06:08'),
(5, 3, 2, 1.5, 2, 3, '2024-03-08 21:06:08');
...
(1, 'john_doe', 'user1@gmail.com', '123456', 'user.png', '2024-03-08 11:33:06'),
(2, 'jane_smith', 'user2@gmail.com', '123456', 'user.png', '2024-03-08 11:33:06');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`room`) REFERENCES `rooms` (`id`);
